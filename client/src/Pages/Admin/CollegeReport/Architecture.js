...
import ServicePie from '../../../images/per college (services)/sii marital (architecture).png'
import MaritalStatus from '../../../images/per college (services)/sii marital (architecture).png'
