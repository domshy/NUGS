...
import ServicePie from '../../../images/per college (services)/services (allied health).png'
import MaritalStatus from '../../../images/per college (services)/sii marital (allied health).png'
            ...
            <div className="coah-container">
                <div className="coah-header">
                    ...
                    <div className="coah-title">
                        <h2>College of Computing and Information Technology</h2>
                    </div>
                </div>
