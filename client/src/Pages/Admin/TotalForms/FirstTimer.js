        ...
        <div className="submittedsii-wrapper">
            ...
            <div className="submittedsii-container">
                <div className="submittedsii-content-header">
                    <h3 style={{color: 'white', textTransform: 'uppercase', fontSize: '14px'}}>
                    List of Student who have been Counselled for the first time </h3>
                    <span id="download-icon"><BsDownload size='1em' /></span>
                </div>
                <div className="submittedsii-contents">
                    <table className="activity-table">
                        ...
                        <tr>
                            <td>2020-0217822</td>
                            <td><Link to="/dashboard/firsttimers/view">View</Link></td>
